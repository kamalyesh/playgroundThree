...
SceneGame::SceneGame(WorkingDirectory& workingDir, ResourceAllocator<sf::Texture>& textureAllocator) : mapParser(/* workingDir, */ textureAllocator), workingDir(workingDir), textureAllocator(textureAllocator) { 
}
