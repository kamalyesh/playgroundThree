...
SceneGame::SceneGame(WorkingDirectory& workingDir, ResourceAllocator<sf::Texture>& textureAllocator) : workingDir(workingDir), textureAllocator(textureAllocator), mapParser(/* workingDir, */ textureAllocator) { 
}
...
void SceneGame::OnCreate()
{
    ...
    int vikingTextureID = textureAllocator.Add(workingDir.Texture() + "Viking.png");
    ...
    std::vector<std::shared_ptr<Object>> levelTiles = mapParser.Parse(workingDir.Tilemap() + "Test Map 1.tmx", mapOffset);
